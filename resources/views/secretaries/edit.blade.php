...
@section('content')
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Actualizar datos de {{$user->name}}</div>
                <form method="POST" action="{{ route('secretary.update',$user->iduser)}}">
                    @csrf
                    @method('PUT')
                    <div class="row">
                       <div class="col-xs-12 col-sm-10 col-sm-offset-1">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-md-offset-2">
                                    <div class="group-material">
                                        <input type="text" class="material-control tooltips-general" placeholder="Escriba el numero de certificado de la secretaria" pattern="[a-zA-Z0-9 ]{1,40}" required="" maxlength="40" data-toggle="tooltip" data-placement="top" title="Numero de certificado" name="numberCer" value="{{ $secretary->num_job_certificate}}">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                ...
                                <div class="col-md-4">
                                    <div class="group-material">
                                        <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el nombre de itulo de la secretaria" pattern="[a-zA-Z ]{1,30}" required maxlength="30" data-toggle="tooltip" data-placement="top" title="Titulo universitario" name="title" value="{{ $secretary->name_title}}">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                            ...
                            <p class="text-center">
                                <a class="btn btn-info" style="margin-right: 20px;" href="{{ route('secretary.index')}}"><i class="zmdi zmdi-roller"></i> &nbsp;&nbsp; Volver</a>
