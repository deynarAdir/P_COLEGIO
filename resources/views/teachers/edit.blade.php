                       ...
                       <div class="col-xs-12 col-sm-10 col-sm-offset-1">
                           ...
                           <br>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="group-material">
                                        <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el numero de item del docente" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ0-9 ]{1,30}" required maxlength="30" data-toggle="tooltip" data-placement="top" title="Numero de item de trabajo" name="numberItem" value="{{ $teacher->num_item }}">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
