        ...
        <form method="POST" action="{{ route('managers.store') }}">
            ...
            <div class="row">
               <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                    ...
                    <div class="group-material">
                        <input type="text" class="material-control tooltips-general" placeholder="ej: 8975464" required="" maxlength="70" data-toggle="tooltip" data-placement="top" name="ci" title="Ingresa una cantdad">
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <label>CI</label>
                    </div>
                    <div class="group-material">
                        <input type="text" class="material-control tooltips-general" placeholder="ej: 7485461" required="" maxlength="70" data-toggle="tooltip" data-placement="top" name="cellphone" title="Ingresa una cantdad">
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <label>CELULAR</label>
                    </div>
