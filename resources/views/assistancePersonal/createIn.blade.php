...
<div class="conteiner-fluid">
    <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
        <li role="presentation"  class="active"><a href="#">Ingreso de personal</a></li>
        <li role="presentation"><a href="{{ route('assistancePersonal.createOut') }}">Salida de personal</a></li>
    </ul>
</div>
<div class="container-fluid">
    <div class="container-flat-form">
        <div class="title-flat-form title-flat-blue">Marcar Ingreso</div>
        {!! Form::open(array('action' => 'AdminControlController@store','method'=>'POST', 'id'=>'frmA')) !!}
